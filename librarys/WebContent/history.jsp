	...
	<div class="suoyin">
		<div>
			<ul class="ui">
				...
				<li class="li"><a href="acurrentServelt" data-hover="Current">Current</a>
			</ul><br>
			<div class="boxx" id="box1">
				<table width="100%" border="0" align="center" cellpadding="5"
					...
					<c:forEach items="${historys}" var="history" varStatus="st">
						<tr align="center">
							<td width="10%">${history.ISBN}</td>
							<td width="15%">${history.ID}</td>
							<td width="15%">${history.borrowtime}</td>
							<td width="15%">${history.returntime}</td>
							<td width="15%">${history.bookname}</td>
							
							<td width="10%">${history.historyfine}</td>
						</tr>
					</c:forEach>
				</table>
				<nav>
