...
<div class="img">
  <a  href="abookmassageServelt?ISBN=${book.ISBN}" onclick="chuanzhi">
...
<form action="AReplyServlet" method="post">
<div class="yijian">
<textarea name="content" ${reply.content} cols="30" rows="5">
...
<div class="chaxun">
<form action="SelectServlet" accept-charset="UTF-8" onsubmit="document.charset='UTF-8';" method="post" >
<select id="s" name="s">
...
<form action="SelectServlet3" accept-charset="UTF-8" onsubmit="document.charset='UTF-8';" method="post" >
<p><input type="submit" value="" name="f" id="f"/>          .........................</p><br/><br/>
