...
<div>
        ...
        <div class="box" id="box2"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" id="item">
					            ...
					            <td  width="20%" ><c:if test="${abook.yu eq 'order'&&abook.borrow eq 'yes' }">
					            
					            <form action="updateServelt?ISBN=${abook.ISBN}&ID=${abook.ID}" method='post'> <input type="submit" value="order" onclick="myFunction()"/></form>
					            </c:if></td>
															          </tr>
