...
<script type="text/javascript">
	 function changeLanguage(){
		...
		document.getElementById("p7").innerHTML="添加读者";
...
<h3 id="p7">Add Reader</h3>
<form
	action="${pageContext.request.contextPath}/servlet/ManageServlet?op=addUser"
	method="post">
	<table class="table table-striped" style="width: 50%;">
		<tr>
			<td id="p1">StuNumber：</td>
			<td>
				 <input name="id"
				class="form-control" placeholder="Please input your stuNumbew"
